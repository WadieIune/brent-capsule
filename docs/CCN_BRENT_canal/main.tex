...
\paragraph{Calidad de dato.} El control geométrico detecta defectos que un
control convencional de cola \emph{no puede ver}, y su valor se expresa en
unidades de riesgo en lugar de en recuento de alertas. Los dos defectos reales
del panel —el precio negativo del WTI y el relleno de calendario, con 1.145
marcas \emph{stale} de las que el 88{,}6\% caen en fin de semana— pasan
inadvertidos para el detector convencional, porque un retorno nulo nunca es un
valor atípico de cola. Depurarlos corrige \textbf{74{,}4 puntos porcentuales} de
distorsión en la contribución al riesgo (la del WTI baja de $0{,}985$ a
$0{,}240$) y elimina el 31{,}1\% de retornos nulos. El monitor diario emite 459
alertas sobre 28.086 observaciones (1{,}63\% de carga operativa) frente a las 30
