...
de volatilidad} no gana ($\Delta\mathrm{AUC}=-0{,}007$; IC 95\%
$[-0{,}021,+0{,}006]$), y añadir la forma a la mejor medida de volatilidad no
aporta nada ($\Delta\mathrm{AUC}=+0{,}006$; IC 95\% $[-0{,}024,+0{,}035]$).

La conclusión es que el módulo funciona, pero \textbf{no por el motivo que se le
atribuía}. Su capacidad no procede de la geometría del canal sino de contener una
