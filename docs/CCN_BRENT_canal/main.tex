...
Sobre esta base de evidencia, el documento especifica el marco de aplicación en
riesgos: un esquema de control de capital en cuatro capas y un cuadro de mando
en el que el detector actúa como descriptor de régimen, nunca como señal de
inversión.
\end{abstract}
